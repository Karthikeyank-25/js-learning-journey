...
function lifeInWeeks(x){
    let daysOfYear = (90*365)-(x*365);
    let weeksOfYear = (90*52)-(x*52);
    let monthsOfYear = (90*12)-(x*12);
    console.log("You have "+daysOfYear+" days, "+weeksOfYear+" weeks, and "+monthsOfYear+" months left.") // Now we get output in the form as we expected
}
